...
class Simulador():
    ...
    def executar_simulacao(self):
        ...
        self.dict_resumo = {
            ...
            "tipo1_n/2_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima]['num_infect_t1'],
            "tipo2_n/2_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima]['num_infect_t2'],
            "curados_n/2_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima]['num_curados'],
            "mortos_n/2_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima]['num_mortos'],
            
            "n/2+1_100%_infectados":metade_infeccao_maxima+1,
            "tipo1_n/2+1_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima+1]['num_infect_t1'],
            "tipo2_n/2+1_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima+1]['num_infect_t2'],
            "curados_n/2+1_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima+1]['num_curados'],
            "mortos_n/2+1_100%_infectados":self.dataframe.iloc[metade_infeccao_maxima+1]['num_mortos'],
            
            "n_100%_infectados":indice_infeccao_maxima,
            "tipo1_n_100%_infectados":self.dataframe.iloc[indice_infeccao_maxima]['num_infect_t1'],
            "tipo2_n_100%_infectados":self.dataframe.iloc[indice_infeccao_maxima]['num_infect_t2'],
            "curados_n_100%_infectados":self.dataframe.iloc[indice_infeccao_maxima]['num_curados'],
            "mortos_n_100%_infectados":self.dataframe.iloc[indice_infeccao_maxima]['num_mortos'],
            
            "n/2_pico":metade_pico_infeccao,
            "tipo1_n/2_pico":self.dataframe.iloc[metade_pico_infeccao]['num_infect_t1'],
            "tipo2_n/2_pico":self.dataframe.iloc[metade_pico_infeccao]['num_infect_t2'],
            "curados_n/2_pico":self.dataframe.iloc[metade_pico_infeccao]['num_curados'],
            "mortos_n/2_pico":self.dataframe.iloc[metade_pico_infeccao]['num_mortos'],
            
            "n/2+1_pico":metade_pico_infeccao+1,
            "tipo1_n/2+1_pico":self.dataframe.iloc[metade_pico_infeccao+1]['num_infect_t1'],
            "tipo2_n/2+1_pico":self.dataframe.iloc[metade_pico_infeccao+1]['num_infect_t2'],
            "curados_n/2+1_pico":self.dataframe.iloc[metade_pico_infeccao+1]['num_curados'],
            "mortos_n/2+1_pico":self.dataframe.iloc[metade_pico_infeccao+1]['num_mortos'],

            "n_pico":indice_pico_infeccao,
            "tipo1_n_pico":self.dataframe.iloc[indice_pico_infeccao]['num_infect_t1'],
            "tipo2_n_pico":self.dataframe.iloc[indice_pico_infeccao]['num_infect_t2'],
            "curados_n_pico":self.dataframe.iloc[indice_pico_infeccao]['num_curados'],
            "mortos_n_pico":self.dataframe.iloc[indice_pico_infeccao]['num_mortos'],
            
            "n_total":self.dataframe.shape[0]-1,
            "sadios_n_total":self.dataframe.iloc[-1]['num_sadios'],
            "curados_n_total":self.dataframe.iloc[-1]['num_curados'],
            "mortos_n_total":self.dataframe.iloc[-1]['num_mortos']
                            }
