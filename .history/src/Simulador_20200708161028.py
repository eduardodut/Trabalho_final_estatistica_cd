...
plt.matshow(sim.lista_matrizes_posicionamento[0], cmap = cmap);plt.show();
sim.iterar()
plt.clf()
plt.matshow(sim.lista_matrizes_posicionamento[1], cmap = cmap);plt.show();
sim.iterar()
plt.clf()
plt.matshow(sim.lista_matrizes_posicionamento[2], cmap = cmap);plt.show();
sim.iterar()
plt.clf()
plt.matshow(sim.lista_matrizes_posicionamento[3], cmap = cmap);plt.show();      
