...
class Simulador():
    ...
    def iterar(self):
        ...
        dict = {
                'num_sadios':self.populacao_inicial - self.num_mortos - self.num_curados - len(self.self.lista_infectados_tipo_1) - len(self.self.lista_infectados_tipo_2) ,
                'num_infect_t1':len(self.self.lista_infectados_tipo_1),
                'num_infect_t2':len(self.self.lista_infectados_tipo_2),
