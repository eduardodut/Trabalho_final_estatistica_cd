...
class Simulador():
    ...
    def __init__(
        ...
        self.df_individuos = pd.DataFrame(data = index= range(tamanho_matriz), columns=range(tamanho_matriz))
        ...
        self.matriz_status = csr_matrix(self.df_individuos.values, dtype=np.uint8)
        print(self.df_individuos)
        dict = {
