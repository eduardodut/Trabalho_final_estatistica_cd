...
class Simulador():
    ...
    def __init__(
        ...
        self.populacao_inicial = densidade_populacional_inicial * tamanho_matriz**2
        self.num_inicial_tipo2 = self.populacao_inicial * percentual_inicial_tipo2
        self.num_inicial_tipo1 = self.populacao_inicial * percentual_inicial_tipo1
...
#print(sim.num_inicial_sadios)
#print(sim.num_inicial_tipo1)
#print(sim.num_inicial_tipo2)


df = pd.DataFrame(columns= ['num_sadios', 'num_infect_t1', 'num_infect_t2', 'num_curados', 'num_mortos'])

df = df.append([sim.num_inicial_sadios, sim.num_inicial_tipo1, sim.num_inicial_tipo2, 0, 0 ])
