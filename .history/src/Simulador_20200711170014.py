...
class Simulador():
    ...
    def iterar(self):
        ...
        populacao_sadia =  self.dataframe.iloc[-1]['num_sadios'] - len(lista_novos_infectados_tipo2+lista_novos_infectados_tipo1+lista_curados_t1+lista_curados_t2+lista_mortos)     
         
        dict = {
                'num_sadios':populacao_sadia,
