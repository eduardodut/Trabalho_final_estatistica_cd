...
for i in range(n_simulacoes):
  ...
  num_inicial_t1 = inserir_infectados_aleatorios*proporcao_t1_t2*num_inicial_infectados
  num_inicial_t2 = inserir_infectados_aleatorios*(1-proporcao_t1_t2)*num_inicial_infectados
  print(num_inicial_t1)
  print(num_inicial_t2)
  sim = Simulador(
      tamanho_matriz,
      num_inicial_t1, 
      num_inicial_t2, 
