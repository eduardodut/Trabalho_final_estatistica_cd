...
class Simulador():
    ...
    def realizar_infeccao(self, lista_infectantes):
    ...
    def iterar(self):
        ...
        lista_novos_infectados_tipo1_1, lista_novos_infectados_tipo2_1 = realizar_infeccao(self.individuos_infectados_tipo_1)
        lista_novos_infectados_tipo1_2, lista_novos_infectados_tipo2_2 = realizar_infeccao(self.individuos_infectados_tipo_2)
        #itera sobre sobre a lista de individuos que infectam e cada um realiza a atividade de infectar
        

        #Verifica morte dos tipo 2


        #Verifica morte dos tipo 
...
percentual_inicial_tipo1 = 0.1   
percentual_inicial_tipo2 = 0.5
