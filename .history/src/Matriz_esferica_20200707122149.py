...
print(matriz.get_vizinho_cima(ponto[0], ponto[1]))
print(matriz.get_vizinho_baixo(ponto[0], ponto[1]))
print(matriz.get_vizinho_esquerda(ponto[0], ponto[1]))
print(matriz.get_vizinho_direita(ponto[0], ponto[1]))