...
class Simulador():
    ...
    def iterar(self):
        ...
        matriz_infectantes = self.matriz_status[(self.matriz_status == self.INFECTADO_TIPO_1) + (self.matriz_status == self.INFECTADO_TIPO_2)]
        # matriz_infectantes = matriz_infectantes[matriz_infectantes < 3]
        indices_infectados = list(zip(*self.matriz_status[(self.matriz_status == self.INFECTADO_TIPO_1) + (self.matriz_status == self.INFECTADO_TIPO_2)].nonzero()))
        indices_infectados = [indice for indice in indices_infectados if indice not in self.lista_infectados_tipo_1]
        indices_infectados = [indice for indice in indices_infectados if indice not in self.lista_infectados_tipo_2]
        # self.num_curados = 0
        #self.num_mortos = 0
        # self.lista_infectados_tipo_1 = []
        # self.lista_infectados_tipo_2 = []
