...
def get_status_coluna(serie):
    return serie.apply(get_status_individuo)

dataframe_individuos = sim.matriz_individuos.apply(get_status_coluna).to_numpy()
print(dataframe_individuos)
print(type(dataframe_individuos))