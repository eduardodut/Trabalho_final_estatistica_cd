            ...
            for x,y in lista_vizinhos:
                ...
                if self.df_individuos.iloc[x,y].status == Individuo.SADIO:
                    ...
                    if novo_status == Individuo.INFECTADO_TIPO_1:
                        ...
                        print("Tipo antes de atribuir: ", self.fabrica_individuo.criar_individuo(Individuo.INFECTADO_TIPO_1,(x,y)))
                        self.df_individuos[x,y] = self.fabrica_individuo.criar_individuo(Individuo.INFECTADO_TIPO_1,(x,y))
...
sim.verificar_infeccao(sim.lista_infectados_tipo_1)
plt.show()
