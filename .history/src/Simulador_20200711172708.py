...
class Simulador():
    ...
    def iterar(self):
        ...
        dict = {
                ...
                'num_infect_t1':np.sum(self.matriz_status == self.INFECTADO_TIPO_1),
                'num_infect_t2':np.sum(self.matriz_status == self.INFECTADO_TIPO_2),
                'num_curados':np.sum(self.matriz_status == self.CURADO),
                'num_mortos':np.sum(self.matriz_status == self.MORTO)}
        # dict = {
