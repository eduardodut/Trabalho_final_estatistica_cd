...
class Simulador():
    ...
    def __init__(
        ...
        self.df_individuos = pd.DataFrame(index= range(tamanho_matriz), columns=range(tamanho_matriz), dtype=Individuo)
        self.df_individuos[:] = self.fabrica_individuo.criar_individuo(10,(0,0))
