...
class Simulador():
    ...
    def __init__(
        ...
        self.matriz_status = csr_matrix((tamanho_matriz,tamanho_matriz), dtype=np.uint8)

        #guarda em matriz esparsa a localização do objeto em sua respectiva lista
        self.matriz_localizacao = csr_matrix((tamanho_matriz,tamanho_matriz), dtype=np.uint32)
            ...
            for vizinho in lista_vizinhos:
                ...
                if self.matriz_status[x,y] == Individuo.SADIO:
                    ...
                    if novo_status == Individuo.INFECTADO_TIPO_2:
                        ...
                        lista_novos_infectados_tipo1.append(self.fabrica_individuo.criar_individuo(Individuo.INFECTADO_TIPO_2,(x,y)))
                        #modifica o status na matriz de status
    ...
    def iterar(self):
        ...
        self.lista_infectados_tipo_2 = [i for i in self.lista_infectados_tipo_2 if i not in lista_mortos]
        ...
        self.lista_infectados_tipo_2 = [i for i in self.lista_infectados_tipo_2 if i not in lista_curados_tipo2]
        self.lista_infectados_tipo_1 = [i for i in self.lista_infectados_tipo_1 if i not in lista_curados_tipo1]

        #adiciona os novos curados na lista geral de curados
        self.lista_curados = self.individuos_curados + lista_curados_tipo1 + lista_curados_tipo2



        # self.  #movimentar infectantes:
        for i in range(len(self.lista_infectados_tipo_1)):
            self.lista_infectados_tipo_1[i] = self.mover_infectante(self.lista_infectados_tipo_1[i])
        
        for i in range(len(self.lista_infectados_tipo_2)):
            self.lista_infectados_tipo_2[i] = self.mover_infectante(self.lista_infectados_tipo_2[i])
        ...
        self.listaen(self.individuos_curados)
    ...
    def mover_infectante(self, infectante):
        ...
        return (novo_x, novo_y) #posicao final
