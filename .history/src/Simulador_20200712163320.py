...
class Simulador():
    ...
    def iterar(self):
        ...
        indices_infectados = [indice for indice in indices_infectados if indice not in self.lista_infectados_tipo_1 and indice not in self.lista_infectados_tipo_2 ]
        # self.num_curados = 0
        #self.num_mortos = 0
