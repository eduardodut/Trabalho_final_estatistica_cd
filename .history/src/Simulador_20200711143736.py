...
class Simulador():
    ...
    def iterar(self):
        ...
        lista_curados_t1 = self.checagem_cura_lista(self.lista_infectados_tipo_2)

        #remove os mortos e curados das listas de infectantes tipo 1 e 2 e adiciona os novos infectados às respectivas listas
        self.lista_infectados_tipo_2 = [indice for indice in self.lista_infectados_tipo_2 if indice not in lista_mortos and indice not in lista_curados_t2] + lista_novos_infectados_tipo2
        self.lista_infectados_tipo_1 = [indice for indice in self.lista_infectados_tipo_1 if indice not in lista_curados_t1] + lista_novos_infectados_tipo1


        #atualiza o número de mortos
        self.num_mortos += len(lista_mortos)
