...
class Simulador():
    ...
    def iterar(self):
        ...
        self.num_mortos = np.sum(self.matriz_status == self.MORTO)
        ...
        dict = {
                'num_sadios': self.populacao_inicial,
                'num_infect_t1':np.sum(self.matriz_status[self.matriz_status == self.INFECTADO_TIPO_1].toarray()),
                'num_infect_t2':np.sum(self.matriz_status[self.matriz_status == self.INFECTADO_TIPO_2].toarray()),
                'num_curados':np.sum(self.matriz_status[self.matriz_status == self.CURADO].toarray()),
                'num_mortos':np.sum(self.matriz_status[self.matriz_status == self.MORTO].toarray())}
        # dict = {
