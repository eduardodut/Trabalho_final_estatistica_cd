...
class Simulador():
    ...
    def __init__(
        ...
        self.num_inicial_tipo2 = populacao_inicial * percentual_inicial_tipo2
        self.num_inicial_tipo1 = populacao_inicial * percentual_inicial_tipo1
        self.num_inicial_sadios = populacao_inicial - (self.num_inicial_tipo2 + self.num_inicial_tipo1)
...
ind = sim.fabrica_individuo.criar_individuo()
