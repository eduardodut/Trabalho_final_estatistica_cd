...
class Individuo():
    ...
    def __init__(self, status, chance_infeccao, chance_infeccao_tipo2, chance_morte, atualizacoes_cura, posicao):
...
individuo_doente = Individuo(Individuo.INFECTADO_TIPO_2, 0.5, 0.5, 0.2, 10, (0,1))
individuo_sadio = Individuo(Individuo.SADIO, 0.5, 0.5, 0.2, 10, (0,1))

individuo_doente.infectar(vizinho= individuo_sadio)

print(individuo_sadio.status)

print(individuo_doente.status)