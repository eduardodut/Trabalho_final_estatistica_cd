...
class Simulador():
    ...
    def __init__(
        ...
        self.matriz_individuos.fillna(self.fabrica_individuo.criar_individuo(Individuo.INFECTADO_TIPO_1,(0,0)))
    ...
    def salvar_posicionamento(self):
        self.lista_matrizes_posicionamento.append(self.matriz_individuos)
