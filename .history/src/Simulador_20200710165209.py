...
class Simulador():
    ...
    def __init__(
        ...
        self.df_individuos.iloc[1,1] = self.fabrica_individuo.criar_individuo(Individuo.SADIO,(0,0))
        
        self.df_individuos.iloc[1,1].status = 2
        print("deu certo")
        print(self.df_individuos)
        
        print(self.df_individuos.to_numpy())
