...
class Simulador():
    ...
    def iterar(self):
        ...
        self.lista_infectados_tipo_2 = [indice for indice in self.lista_infectados_tipo_2 if indice not in lista_mortos and indice not in lista_curados_t2]
...
print(sim.matriz_atualizacoes_cura[sim.matriz_status == 1].toarray() = sim.matriz_atualizacoes_cura[sim.matriz_status == 1].toarray() - 1)
#plt.show()
#print(sim.dataframe)
# print(sim.lista_infectados_tipo_1)
# print(sim.lista_infectados_tipo_2)
