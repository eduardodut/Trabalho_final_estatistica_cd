...
class Simulador():
    ...
    def __init__(
        ...
        self.df_individuos = pd.DataFrame(self.criar_individuo(Individuo.SADIO,(0,0)), index= range(tamanho_matriz), columns=range(tamanho_matriz))
        self.matriz_status = lil_matrix((4,tamanho_matriz, tamanho_matriz),dtype= np.uint8)
    ...
    def verificar_infeccao(self, lista_infectantes):
        ...
        for X,Y in lista_infectantes:
            ...
            for x,y in lista_vizinhos:
                ...
                if self.df_individuos.loc[x,y].status == Individuo.SADIO:
                    ...
                    if novo_status == Individuo.INFECTADO_TIPO_1:
                        ...
                        self.df_individuos.loc[x,y] = self.criar_individuo(Individuo.INFECTADO_TIPO_1,(x,y))
                    ...
                    if novo_status == Individuo.INFECTADO_TIPO_2:
                        ...
                        #modifica o status na matriz de status
                        self.df_individuos.loc[x,y] = self.criar_individuo(Individuo.INFECTADO_TIPO_2,(x,y))
