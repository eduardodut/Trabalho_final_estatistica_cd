...
class Simulador():
    ...
    def iterar(self):
        ...
        matriz_infectantes = self.matriz_status[self.matriz_status > self.SADIO]
        matriz_infectantes = matriz_infectantes[matriz_infectantes < self.CURADO]
        
        print(matriz_infectantes.get_shape())
        
        # matriz_infectantes = matriz_infectantes[matriz_infectantes < 3]
        indices_infectados = list(zip(*matriz_infectantes.nonzero()))
