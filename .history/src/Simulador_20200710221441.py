...
print("Valor 1: ", sim.dataframe.iloc[-1]['num_infect_t1'])
print("Valor 2: ", sim.dataframe.iloc[-1]['num_infect_t2'])
while sim.dataframe.iloc[-1]['num_infect_t1'][1]+sim.dataframe.iloc[-1]['num_infect_t2'][1] > 0:
