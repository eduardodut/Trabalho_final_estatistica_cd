...
class Simulador():
    ...
    def __init__(
        ...
        self.densidade_populacional_inicial = densidade_populacional_inicial

        self.matriz_individuos = []
        self.fabrica_individuo = None
...
class Fabrica_individuo():
    ...
    def cria_individuo_tipo_2():
        return Individuo(
            Individuo.INFECTADO_TIPO_2, 
            self.chance_infeccao, 
            self.chance_infeccao_tipo2, 
            self.chance_morte, 
            self.atualizacoes_cura)

sim = Simulador(100, 0.5)
...
sim.set_condicoes_iniciais(chance_infeccao, chance_infeccao_tipo2, chance_morte, atualizacoes_cura, percentual_inicial_tipo1, percentual_inicial_tipo2 )


sim.fabrica_individuo.cria_individuo_tipo_2()
