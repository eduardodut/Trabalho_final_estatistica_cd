...
class Simulador():
    ...
    def iterar(self):
        ...
        self.lista_infectados_tipo_2 = [indice for indice in self.lista_infectados_tipo_2 if indice not in lista_mortos_atualizacao and not in lista_curados_t2_atualizacao]
